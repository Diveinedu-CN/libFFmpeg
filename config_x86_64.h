...
#define FFMPEG_CONFIGURATION "--target-os=darwin --arch=x86_64 --cc='xcrun -sdk iphonesimulator clang' --enable-cross-compile --disable-debug --disable-programs --disable-doc --enable-pic --enable-nonfree --enable-libx264 --enable-gpl --enable-avresample --extra-cflags='-arch x86_64 -mios-simulator-version-min=6.0 -I/Users/apple/opensource/FFmpeg-iOS-build-script/x264/x264-iOS/include' --extra-cxxflags='-arch x86_64 -mios-simulator-version-min=6.0' --extra-ldflags='-arch x86_64 -mios-simulator-version-min=6.0 -L/Users/apple/opensource/FFmpeg-iOS-build-script/x264/x264-iOS/lib' --prefix=/Users/apple/opensource/FFmpeg-iOS-build-script/thin/x86_64"
#define FFMPEG_LICENSE "nonfree and unredistributable"
#define CONFIG_THIS_YEAR 2015
#define FFMPEG_DATADIR "/Users/apple/opensource/FFmpeg-iOS-build-script/thin/x86_64/share/ffmpeg"
#define AVCONV_DATADIR "/Users/apple/opensource/FFmpeg-iOS-build-script/thin/x86_64/share/ffmpeg"

...
#define FFMPEG_CONFIGURATION "--target-os=darwin --arch=arm64 --cc='xcrun -sdk iphoneos clang' --enable-cross-compile --disable-debug --disable-programs --disable-doc --enable-pic --enable-nonfree --enable-libx264 --enable-gpl --enable-avresample --extra-cflags='-arch arm64 -mios-version-min=6.0 -I/Users/apple/opensource/FFmpeg-iOS-build-script/x264/x264-iOS/include' --extra-cxxflags='-arch arm64 -mios-version-min=6.0' --extra-ldflags='-arch arm64 -mios-version-min=6.0 -L/Users/apple/opensource/FFmpeg-iOS-build-script/x264/x264-iOS/lib' --prefix=/Users/apple/opensource/FFmpeg-iOS-build-script/thin/arm64"
#define FFMPEG_LICENSE "nonfree and unredistributable"
#define CONFIG_THIS_YEAR 2015
#define FFMPEG_DATADIR "/Users/apple/opensource/FFmpeg-iOS-build-script/thin/arm64/share/ffmpeg"
#define AVCONV_DATADIR "/Users/apple/opensource/FFmpeg-iOS-build-script/thin/arm64/share/ffmpeg"
